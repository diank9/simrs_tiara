...
public class DlgCariTagihanOperasi11 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgCariTagihanOperasi11(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void BtnCari5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari5ActionPerformed
        akses.setform("DlgCariTagihanOperasi11");
        ...
        member.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgCariTagihanOperasi11")) {
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariTagihanOperasi11 dialog = new DlgCariTagihanOperasi11(new javax.swing.JFrame(), true);
