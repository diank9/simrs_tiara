...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnRiwayatPenunjang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); 
        BtnRiwayatPenunjang.setText("Riwayat Penunjang");
        BtnRiwayatPenunjang.setFocusPainted(false);
        BtnRiwayatPenunjang.setFont(new java.awt.Font("Tahoma", 0, 11)); 
        BtnRiwayatPenunjang.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnRiwayatPenunjang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatPenunjang.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayatPenunjang.setName("BtnRiwayatPenunjang"); 
        BtnRiwayatPenunjang.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnRiwayatPenunjang.setRoundRect(false);
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+"")+" "+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem())==true){
                    // 🔎 Tambahan validasi khusus TabRawat index 3
//                if(TabRawat.getSelectedIndex()==3){
//                    String kd_pj = Sequel.cariIsi(
//                        "select kd_pj from reg_periksa where no_rawat=?", TNoRw.getText()
//                    );
//                    
//                    if(kd_pj.equalsIgnoreCase("BPJ")){
//                        int cek = Sequel.cariInteger(
//                            "select count(no_rawat) from bridging_sep where no_rawat=? " +
//                            "union all " +
//                            "select count(no_rawat) from bridging_sep_internal where no_rawat=?",
//                            TNoRw.getText(),TNoRw.getText()
//                        );
//                        if(cek==0){
//                            JOptionPane.showMessageDialog(null,
//                                "Pasien dengan penjamin BPJS wajib memiliki SEP. " +
//                                "Data SEP tidak ditemukan, simpan dibatalkan.");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnRiwayatPenunjangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
    ...
    */
    ...
    public void isCek(){
        ...
        BtnRiwayatPenunjang.setVisible(akses.getresume_pasien());
        Btn5Soap.setEnabled(akses.getresume_pasien());
        if(akses.getresume_pasien()==true){
            tinggi=tinggi+24;
        }
    ...
    private void inputObat() {
        DlgCariObat1 dlgobt=new DlgCariObat1(null,false);
    ...
    private void initRawatJalan(){
        ...
        FormMenu.add(BtnRiwayatPenunjang);
