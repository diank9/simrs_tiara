...
public class DlgTagihanOperasi1 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgTagihanOperasi1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        Laporan.setDocument(new batasInput((int)8000).getKata(Laporan));
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(89, 440));
        ...
        TPasien.setBounds(265, 10, 560, 23);
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        DlgCariTagihanOperasi11 form = new DlgCariTagihanOperasi11(null, false);

        String noRawat = TNoRw.getText();

        form.setPasien(noRawat);
...
//        Valid.pindah(evt,kdonloop4,tgl2);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTagihanOperasi1 dialog = new DlgTagihanOperasi1(new javax.swing.JFrame(), true);
