...
import bridging.koneksiDBMEDLIS;
...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKirimMEDLIS = new widget.Button();
        BtnAmbilMEDLIS = new widget.Button();
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-12-2025 18:07:05" }));
        ...
        BtnKirimMEDLIS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimMEDLIS.setText("Kirim Permintaan ke MEDLIS");
        BtnKirimMEDLIS.setFocusPainted(false);
        BtnKirimMEDLIS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimMEDLIS.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimMEDLIS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimMEDLIS.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimMEDLIS.setName("BtnKirimMEDLIS"); // NOI18N
        BtnKirimMEDLIS.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnKirimMEDLIS.setRoundRect(false);
        BtnKirimMEDLIS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimMEDLISActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimMEDLIS);

        BtnAmbilMEDLIS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAmbilMEDLIS.setText("Ambil Hasil dari MEDLIS");
        BtnAmbilMEDLIS.setFocusPainted(false);
        BtnAmbilMEDLIS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAmbilMEDLIS.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAmbilMEDLIS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAmbilMEDLIS.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAmbilMEDLIS.setName("BtnAmbilMEDLIS"); // NOI18N
        BtnAmbilMEDLIS.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAmbilMEDLIS.setRoundRect(false);
        BtnAmbilMEDLIS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilMEDLISActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAmbilMEDLIS);
...
private void tbLabRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabRalanKeyPressed
    ...
    private void BtnKirimMEDLISActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimMEDLISActionPerformed
        // TODO add your handling code here:
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.equals("")) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    try {
                        Connection koneksimedlis = koneksiDBMEDLIS.condb();

                        ps = koneksi.prepareStatement(
                                "SELECT "
                                + "    permintaan_lab.noorder, permintaan_lab.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien, "
                                + "    permintaan_lab.tgl_permintaan, permintaan_lab.jam_permintaan, permintaan_lab.status, "
                                + "    permintaan_lab.informasi_tambahan, permintaan_lab.diagnosa_klinis, "
                                + "    permintaan_lab.dokter_perujuk AS kd_dokter, dokter.nm_dokter, "
                                + "    reg_periksa.kd_pj, penjab.png_jawab, "
                                + "    pasien.jk, pasien.tgl_lahir, pasien.alamat, pasien.no_ktp, "
                                + "    permintaan_detail_permintaan_lab.kd_jenis_prw, "
                                + "    jns_perawatan_lab.nm_perawatan AS nm_perawatan, "
                                + "    jns_perawatan_lab.kategori, "
                                + "    permintaan_detail_permintaan_lab.id_template, "
                                + "    SUBSTRING_INDEX(template_laboratorium.Pemeriksaan, ',', 1) AS nm_pemeriksaan, "
                                + "    template_laboratorium.satuan, "
                                + "    CASE "
                                + "        WHEN pasien.jk = 'L' AND TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) >= 18 THEN template_laboratorium.nilai_rujukan_ld "
                                + "        WHEN pasien.jk = 'L' AND TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) < 18 THEN template_laboratorium.nilai_rujukan_la "
                                + "        WHEN pasien.jk = 'P' AND TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) >= 18 THEN template_laboratorium.nilai_rujukan_pd "
                                + "        WHEN pasien.jk = 'P' AND TIMESTAMPDIFF(YEAR, pasien.tgl_lahir, CURDATE()) < 18 THEN template_laboratorium.nilai_rujukan_pa "
                                + "        ELSE '' "
                                + "    END AS nilai_rujukan, "
                                + "    '' AS hasil, '' AS nn, '' AS flag, '' AS keterangan, "
                                + "    '' AS status_his, '' AS status_lis, "
                                + "    reg_periksa.kd_poli as kd_poli, poliklinik.nm_poli as nm_poli "
                                + "FROM permintaan_lab "
                                ...
                                + "    permintaan_detail_permintaan_lab.kd_jenis_prw = template_laboratorium.kd_jenis_prw "
                                + "    AND permintaan_detail_permintaan_lab.id_template = template_laboratorium.id_template "
                                + "WHERE permintaan_lab.noorder = ?"
                        );
                        ...
                        while (rs.next()) {
//                    System.out.println(NoPermintaan);
                            PreparedStatement psInsert = koneksimedlis.prepareStatement(
                                    "INSERT INTO tbl_bridging ("
                                    + "noorder, no_rawat, tgl_permintaan, jam_permintaan, status, informasi_tambahan, diagnosa_klinis, "
                                    + "kd_dokter, nm_dokter, no_rkm_medis, kd_poli, nm_poli, kd_pj, png_jawab, "
                                    + "nm_pasien, no_ktp, jk, tgl_lahir, alamat, kd_jenis_prw, nm_perawatan, kategori, "
                                    + "id_template, nm_pemeriksaan, hasil, satuan, nn, flag, keterangan, status_his, status_lis, nilai_rujukan) "
                                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
                            );

                            psInsert.setString(1, rs.getString("noorder"));
                            psInsert.setString(2, rs.getString("no_rawat"));
                            psInsert.setString(3, rs.getString("tgl_permintaan"));
                            psInsert.setString(4, rs.getString("jam_permintaan"));
                            psInsert.setString(5, rs.getString("status"));
                            psInsert.setString(6, rs.getString("informasi_tambahan"));
                            psInsert.setString(7, rs.getString("diagnosa_klinis"));
                            psInsert.setString(8, rs.getString("kd_dokter"));
                            psInsert.setString(9, rs.getString("nm_dokter"));
                            psInsert.setString(10, rs.getString("no_rkm_medis"));
                            psInsert.setString(11, rs.getString("kd_poli"));
                            psInsert.setString(12, rs.getString("nm_poli"));
                            psInsert.setString(13, rs.getString("kd_pj"));
                            psInsert.setString(14, rs.getString("png_jawab"));
                            psInsert.setString(15, rs.getString("nm_pasien"));
                            psInsert.setString(16, rs.getString("no_ktp"));
                            psInsert.setString(17, rs.getString("jk"));
                            psInsert.setString(18, rs.getString("tgl_lahir"));
                            psInsert.setString(19, rs.getString("alamat"));
                            psInsert.setString(20, rs.getString("kd_jenis_prw"));
                            psInsert.setString(21, rs.getString("nm_perawatan"));
                            psInsert.setString(22, rs.getString("kategori"));
                            psInsert.setString(23, rs.getString("id_template"));
                            psInsert.setString(24, rs.getString("nm_pemeriksaan"));
                            psInsert.setString(25, rs.getString("hasil"));
                            psInsert.setString(26, rs.getString("satuan"));
                            psInsert.setString(27, rs.getString("nn"));
                            psInsert.setString(28, "0"); // flag default
                            psInsert.setString(29, rs.getString("keterangan"));
                            psInsert.setString(30, "0"); // status_his default
                            psInsert.setString(31, "0"); // status_lis default
                            psInsert.setString(32, rs.getString("nilai_rujukan")); // nilai rujukan berdasarkan umur & gender
        ...
        if (TabPilihRawat.getSelectedIndex() == 1) {
            if (!NoRawat.equals("")) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    Valid.textKosong(TCari, "No.Permintaan");
                    ...
                    try {
                        ...
                        ps = koneksi.prepareStatement(
                                ...
                                + "    '' AS hasil, '' AS nn, '' AS flag, '' AS keterangan, "
                                + "    '' AS status_his, '' AS status_lis, "
                                + "    kamar_inap.kd_kamar AS kd_poli, bangsal.nm_bangsal AS nm_poli "
                                + "FROM permintaan_lab "
                                + "INNER JOIN reg_periksa ON permintaan_lab.no_rawat = reg_periksa.no_rawat "
                                + "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "
                                + "INNER JOIN dokter ON permintaan_lab.dokter_perujuk = dokter.kd_dokter "
...
//                    System.out.println(NoPermintaan);
    ...
    }//GEN-LAST:event_BtnKirimMEDLISActionPerformed

    private void BtnAmbilMEDLISActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilMEDLISActionPerformed
        // TODO add your handling code here:
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (!NoRawat.equals("")) {
                    if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                        ...
                        if (Sampel.equals("")) {
                            ...
                            dlgro.emptTeks();
                            dlgro.isCek();
                            dlgro.setOrderMEDLIS(NoPermintaan, NoRawat, "Ralan");
                            dlgro.setDokterPerujuk(KodeDokter, DokterPerujuk);
                            TeksKosong();
                            dlgro.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
                ...
                if (!NoRawat.equals("")) {
                    if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                        ...
                        if (Sampel.equals("")) {
                            ...
                            dlgro.emptTeks();
                            dlgro.isCek();
                            dlgro.setOrderMEDLIS(NoPermintaan, NoRawat, "Ranap");
                            dlgro.setDokterPerujuk(KodeDokter, DokterPerujuk);
                            TeksKosong();
                            dlgro.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
    ...
    }//GEN-LAST:event_BtnAmbilMEDLISActionPerformed
    ...
    private widget.Button BtnAmbilMEDLIS;
    ...
    private widget.Button BtnKirimMEDLIS;
