...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private String keputusan = "", pilihan = "", datatriase = "", finger = "", kodepetugas = "", FileName = "", kodeberkas = "", tgl;
    ...
    private void initComponents() {
        ...
        BtnEditUpload = new widget.Button();
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-12-2025 13:55:56" }));
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-12-2025 13:55:57" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-12-2025 13:55:57" }));
        ...
        BtnEditUpload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/inventaris.png"))); // NOI18N
        BtnEditUpload.setMnemonic('G');
        BtnEditUpload.setText("G & U");
        BtnEditUpload.setToolTipText("Alt+G");
        BtnEditUpload.setName("BtnEditUpload"); // NOI18N
        BtnEditUpload.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnEditUpload.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnEditUploadActionPerformed(evt);
            }
        });
        BtnEditUpload.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnEditUploadKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnEditUpload);
    ...
    private void BtnBatalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnBatalKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnSimpanUpload, BtnHapus);
        }
    ...
    private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnBatal, BtnEditUpload);
        }
    ...
    private void BtnEditUploadKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditUploadKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            BtnEditActionPerformed(null);
        } else {
            Valid.pindah(evt, BtnHapus, BtnPrint);
        }
}//GEN-LAST:event_BtnEditUploadKeyPressed
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnEditUpload, TCari);
        }
    ...
    private void BtnPrintKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnEditUpload, BtnKeluar);
        }
    ...
    private void btnSekunderPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnSekunderPetugasKeyPressed
        Valid.pindah(evt, SekunderTanggalTriase, BtnSimpanUpload);
    ...
    private void btnPrimerPetugasKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPrimerPetugasKeyReleased
        Valid.pindah(evt, PrimerTanggalTriase, BtnSimpanUpload);
    ...
    private void BtnSimpanUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanUploadActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            sukses = true;
            int skalaAktif = 0; // Variable untuk menyimpan skala yang aktif
                ...
                if (PrimerKeluhanUtama.getText().trim().equals("")) {
                    ...
                    if (Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 13, new String[]{
                        ...
                        if (Sequel.menyimpantf2("data_triase_igdprimer", "?,?,?,?,?,?,?", 7, new String[]{
                            ...
                            if (TabSkala1dan2.getSelectedIndex() == 0) {
                                skalaAktif = 1; // Set skala 1 aktif
                                for (i = 0; i < tbSkala1.getRowCount(); i++) {
                                    if (tbSkala1.getValueAt(i, 0).toString().equals("true")) {
                                ...
                                skalaAktif = 2; // Set skala 2 aktif
                                for (i = 0; i < tbSkala2.getRowCount(); i++) {
                                    if (tbSkala2.getValueAt(i, 0).toString().equals("true")) {
                ...
                if (SekunderAnamnesa.getText().trim().equals("")) {
                    ...
                    if (Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 13, new String[]{
                        ...
                        if (Sequel.menyimpantf2("data_triase_igdsekunder", "?,?,?,?,?,?", 6, new String[]{
                            ...
                            if (TabSkala3dan4dan5.getSelectedIndex() == 0) {
                                skalaAktif = 3; // Set skala 3 aktif
                                for (i = 0; i < tbSkala3.getRowCount(); i++) {
                                    if (tbSkala3.getValueAt(i, 0).toString().equals("true")) {
                                ...
                                skalaAktif = 4; // Set skala 4 aktif
                                for (i = 0; i < tbSkala4.getRowCount(); i++) {
                                    if (tbSkala4.getValueAt(i, 0).toString().equals("true")) {
                                ...
                                skalaAktif = 5; // Set skala 5 aktif
                                for (i = 0; i < tbSkala5.getRowCount(); i++) {
                                    if (tbSkala5.getValueAt(i, 0).toString().equals("true")) {
            ...
            // ========== PROSES UPLOAD OTOMATIS SETELAH SIMPAN BERHASIL ==========
            if (sukses == true) {
                String noRawatUpload = TNoRw.getText();
...
//                    System.out.println("No Rawat: " + noRawatUpload);
                    ...
                    final String noRawatFinal = noRawatUpload;
...
//                                    System.out.println("Konversi PDF ke JPG berhasil");
                                    ...
                                    javax.swing.SwingUtilities.invokeLater(() -> {
                                        JOptionPane.showMessageDialog(null,
                                                "Data tersimpan, tapi gagal konversi dokumen ke JPG");
                                    });
                                }
                            } else {
                                ...
                                javax.swing.SwingUtilities.invokeLater(() -> {
                                    JOptionPane.showMessageDialog(null,
                                            "Data tersimpan, tapi gagal generate PDF dokumen");
                                });
                            }
                        } catch (Exception e) {
                            System.out.println("Error auto upload: " + e);
                            e.printStackTrace();
                        }
                    }).start();

                } else {
                    System.out.println("Warning: Skala tidak terdeteksi, upload otomatis tidak dijalankan");
                }

                // Empty form tetap dijalankan langsung
                emptTeks();
            }
        }
    ...
    private widget.Button BtnEditUpload;
    ...
    public void isCek() {
        BtnSimpanUpload.setEnabled(akses.getdata_triase_igd());
        BtnHapus.setEnabled(akses.getdata_triase_igd());
        BtnPrint.setEnabled(akses.getdata_triase_igd());
        BtnEditUpload.setEnabled(akses.getdata_triase_igd());
...
//                                });
    ...
    private boolean CreatePDFTriaseIGD(String noRawat, int skala) {
        ...
        // Tentukan tabel dan report berdasarkan skala
        String tabelTriase = "";
        String reportName = "";
        String fieldKeluhan = "";
        String fieldKebutuhanKhusus = "";

        if (skala == 1 || skala == 2) {
            // Skala 1 dan 2 menggunakan data_triase_igdprimer
            tabelTriase = "data_triase_igdprimer";
            fieldKeluhan = "keluhan_utama";
            fieldKebutuhanKhusus = "kebutuhan_khusus";
        } else {
            // Skala 3, 4, 5 menggunakan data_triase_igdsekunder
            tabelTriase = "data_triase_igdsekunder";
            fieldKeluhan = "anamnesa_singkat";
            fieldKebutuhanKhusus = "''"; // tidak ada field ini di sekunder
        }

        reportName = "rptLembarTriaseSkala" + skala + ".jasper";

        try {
            // Query data utama triase
            String queryUtama = "select " + tabelTriase + "." + fieldKeluhan + ","
                    + (fieldKebutuhanKhusus.equals("''") ? "" : tabelTriase + "." + fieldKebutuhanKhusus + ",")
                    + tabelTriase + ".catatan," + tabelTriase + ".plan," + tabelTriase + ".tanggaltriase,"
                    + tabelTriase + ".nik,data_triase_igd.tekanan_darah,data_triase_igd.nadi,"
                    + "data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,"
                    + "data_triase_igd.nyeri,data_triase_igd.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,"
                    + "pasien.jk,pasien.tgl_lahir,pegawai.nama,data_triase_igd.tgl_kunjungan,"
                    + "data_triase_igd.cara_masuk,master_triase_macam_kasus.macam_kasus "
                    + "from " + tabelTriase + " inner join data_triase_igd "
                    + "inner join pasien inner join pegawai inner join reg_periksa "
                    + "inner join master_triase_macam_kasus on "
                    + "data_triase_igd.no_rawat=" + tabelTriase + ".no_rawat and "
                    + "reg_periksa.no_rawat=data_triase_igd.no_rawat and "
                    + "reg_periksa.no_rkm_medis=pasien.no_rkm_medis and "
                    + "pegawai.nik=" + tabelTriase + ".nik and "
                    + "master_triase_macam_kasus.kode_kasus=data_triase_igd.kode_kasus "
                    + "where data_triase_igd.no_rawat=?";

            ps = koneksi.prepareStatement(queryUtama);
            ...
            if (rs.next()) {
                ...
                param.put("caradatang", rs.getString("cara_masuk"));
                param.put("macamkasus", rs.getString("macam_kasus"));
                param.put("keluhanutama", rs.getString(fieldKeluhan));

                // Field kebutuhan khusus hanya untuk skala 1 dan 2
                if (!fieldKebutuhanKhusus.equals("''")) {
                    param.put("kebutuhankhusus", rs.getString(fieldKebutuhanKhusus));
                }
                ...
                // Query data detail triase sesuai skala
                String queryDetail = "select master_triase_pemeriksaan.kode_pemeriksaan,master_triase_pemeriksaan.nama_pemeriksaan "
                        + "from master_triase_pemeriksaan inner join master_triase_skala" + skala + " "
                        + "inner join data_triase_igddetail_skala" + skala + " "
                        + "on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala" + skala + ".kode_pemeriksaan and "
                        + "master_triase_skala" + skala + ".kode_skala" + skala + "=data_triase_igddetail_skala" + skala + ".kode_skala" + skala + " "
                        + "where data_triase_igddetail_skala" + skala + ".no_rawat=? "
                        + "group by master_triase_pemeriksaan.kode_pemeriksaan "
                        + "order by master_triase_pemeriksaan.kode_pemeriksaan";

                ps2 = koneksi.prepareStatement(queryDetail);
                ...
                try {
                    ...
                    while (rs2.next()) {
                        ...
                        String queryPengkajian = "select master_triase_skala" + skala + ".pengkajian_skala" + skala + " "
                                + "from master_triase_skala" + skala + " inner join data_triase_igddetail_skala" + skala + " "
                                + "on master_triase_skala" + skala + ".kode_skala" + skala + "=data_triase_igddetail_skala" + skala + ".kode_skala" + skala + " "
                                + "where master_triase_skala" + skala + ".kode_pemeriksaan=? and data_triase_igddetail_skala" + skala + ".no_rawat=? "
                                + "order by data_triase_igddetail_skala" + skala + ".kode_skala" + skala;

                        ps3 = koneksi.prepareStatement(queryPengkajian);
                        ...
                        try {
                            ...
                            while (rs3.next()) {
                                datatriase = rs3.getString("pengkajian_skala" + skala) + ", " + datatriase;
                            }
                        } catch (Exception e) {
                ...
                // Generate PDF
                tgl = new SimpleDateFormat("HH.mm.ss").format(new Date());
                FileName = "TriaseIGD_" + noRawat.replaceAll("/", "") + "_at_" + tgl;

                String queryTemp = "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no";
...
//                System.out.println("PDF Triase IGD berhasil dibuat: " + FileName);
    ...
    private boolean ConvertPDFtoJPGTriase(String noRawat) {
        boolean success = false;
        File filePDF = new File("tmpPDF/" + FileName + ".pdf");
        ...
        if (filePDF.exists()) {
            try {
                ...
                // Render halaman pertama dengan resolusi 300 DPI
                BufferedImage bim = pdfRenderer.renderImageWithDPI(0, 300, ImageType.RGB);

                // Simpan sebagai JPG
                File outputfile = new File("tmpPDF/" + FileName + ".jpg");
...
//                System.out.println("Konversi PDF ke JPG Triase berhasil");
            ...
            System.out.println("File PDF Triase IGD tidak ditemukan");
        }

        return success;
    }

    private void UploadJPGTriaseSilent(String noRawat) {
        try {
...
//            System.out.println("File JPG ditemukan: " + file.length() + " bytes");
            ...
            // PENTING: Gunakan struktur URL yang sama dengan SuratSakit
            // Parameter doc di query string, bukan di multipart body
...
//                System.out.println("Upload Triase IGD berhasil ke server");
                ...
                // Jika belum ada, buat kode berkas baru
...
//                    System.out.println("Menggunakan kode berkas: " + kodeberkas);
                ...
                if (Sequel.cariInteger("SELECT COUNT(no_rawat) AS jumlah FROM berkas_digital_perawatan "
                    ...
                    System.out.println("Update berkas digital existing");
                } else {
                    // Insert data baru
...
//                    System.out.println("Upload berkas digital berhasil: " + FileName + ".jpg");
                ...
                System.out.println("ERROR: Upload gagal dengan status code: " + statusCode);
            }

        } catch (Exception e) {
            System.out.println("Upload JPG Triase error: " + e);
            e.printStackTrace();
        }
    }
