 ...
 * @author dosen
 */
public final class RMCariPenilaian extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariPenilaian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Penilaian","Dokter/Petugas"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariPenilaian dialog = new RMCariPenilaian(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.penilaian,pegawai.nama "+
                    "from pemeriksaan_ralan " +
                    "INNER JOIN pegawai ON pemeriksaan_ralan.nip = pegawai.nik "+
                    "where pemeriksaan_ralan.no_rawat=? and "+
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.penilaian,pegawai.nama "+
                    "from pemeriksaan_ranap " +
                    "INNER JOIN pegawai ON pemeriksaan_ranap.nip = pegawai.nik "+
                    "where pemeriksaan_ranap.no_rawat=? and "+
